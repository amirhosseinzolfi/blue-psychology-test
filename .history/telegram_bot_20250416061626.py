...
def start(update: Update, context: CallbackContext) -> None:
    # Create a Persian reply keyboard with two test command buttons.
    keyboard = [[ "/آزمون_روانشناسی", "/آزمون_شخصیتی" ]]
...
def start_test(update: Update, context: CallbackContext) -> None:
    ...
    if update.message.text == "/آزمون_روانشناسی":
        test_type = "A"
    elif update.message.text == "/آزمون_شخصیتی":
        test_type = "B"
...
def main():
    ...
    # Add new command handlers for Persian test buttons.
    dispatcher.add_handler(CommandHandler("آزمون_روانشناسی", start_test))
    dispatcher.add_handler(CommandHandler("آزمون_شخصیتی", start_test))
